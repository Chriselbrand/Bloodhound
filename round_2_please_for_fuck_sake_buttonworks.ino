...
#define YELLOW_COLOR 0xFFFE00 //yellow
...
//    while (AlphaR_time == 0) {AlphaR_time = AlphaR.ping_median(5);}
    unsigned int AlphaL_time = AlphaL.ping_median(5); // Send ping, get ping time in microseconds (uS).
//    while (AlphaL_time == 0) {AlphaL_time = AlphaL.ping_median(5);}
...
//        while (AlphaL_time == 0) {AlphaL_time = AlphaL.ping();}
        AlphaR_time = AlphaR.ping();
//        while (AlphaR_time == 0) {AlphaR_time = AlphaR.ping();}
...
//    while (BravoR_time == 0) {BravoR_time = BravoR.ping_median(5);}
    unsigned int BravoL_time = BravoL.ping_median(5); // Send ping, get ping time in microseconds (uS).
//    while (BravoL_time == 0) {BravoL_time = BravoL.ping_median(5);}
    //difference from goal and absolute value for error correction
...
//        while (BravoL_time == 0) {BravoL_time = BravoL.ping();}
        BravoR_time = BravoR.ping();
//        while (BravoR_time == 0) {BravoR_time = BravoR.ping();}
...
//    while (CharlieR_time == 0) {CharlieR_time = CharlieR.ping_median(5);}
    unsigned int CharlieL_time = CharlieL.ping_median(5); // Send ping, get ping time in microseconds (uS).
//    while (CharlieL_time == 0) {CharlieL_time = CharlieL.ping_median(5);}
    //difference from goal and absolute value for error correction
...
//        while (CharlieL_time == 0) {CharlieL_time = CharlieL.ping();}
        CharlieR_time = CharlieR.ping();
//        while (CharlieR_time == 0) {CharlieR_time = CharlieR.ping();}
...
//    while (DeltaR_time == 0) {DeltaR_time = DeltaR.ping_median(5);}
    unsigned int DeltaL_time = DeltaL.ping_median(5); // Send ping, get ping time in microseconds (uS).
//    while (DeltaL_time == 0) {DeltaL_time = DeltaL.ping_median(5);}
    //difference from goal and absolute value for error correction
...
//        while (DeltaL_time == 0) {DeltaL_time = DeltaL.ping();}
        DeltaR_time = DeltaR.ping();
//        while (DeltaR_time == 0) {DeltaR_time = DeltaR.ping();}
